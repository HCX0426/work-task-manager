...
function helpHTML(){
  ...
  <div class="help-step"><span class="hs-num">1</span><div class="hs-body"><div class="hs-t">每日录入：把每天的任务记下来</div><div class="hs-d">打开「每日录入」，顶部「今日待办」会列出今天要推进和已逾期的任务，点条目可直接补录；表单里填专案名称、需求、进度等（厂区/日期/负责人已预填）→ 保存。「完成状态」必选（Ongoing/Planning/Testing/Paused/Closed/Cancelled）；改「Paused/Cancelled」需先填「备注」说明原因；「开发进度」支持每行写一个推进节点、行首加「✓ 」表示完成，进度条自动统计，也有常用短语/语音/AI 润色辅助。</div></div></div>
  ...
  <h3>🗂 功能导览</h3>
  <div class="help-card">
    <div class="help-mod"><div class="hm-name">每日录入</div><div class="hm-d">今日待办/逾期/本周已录、预填默认值、克隆上条、批量录入、语音、AI 润色、常用短语、开发进度逐行推进（✓ 自动统计进度）、状态必选（Paused/Cancelled 需备注）、重复检测、草稿自动保存</div></div>
